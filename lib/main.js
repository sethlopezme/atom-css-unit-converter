...
class CSSUnitConverter {
  ...
  activate() {
    ...
    subscriptions.add(atom.commands.add('atom-text-editor', {
      'css-unit-converter:pixels-to-ems': convert,
      'css-unit-converter:pixels-to-percents': convert,
      'css-unit-converter:pixels-to-points': convert,
      'css-unit-converter:pixels-to-rems': convert
    }));
  }
  ...
  convert(event) {
    ...
    if (editor) {
      const config = {
        comments: atom.config.get('css-unit-converter.comments'),
        decimalLength: atom.config.get('css-unit-converter.decimalLength'),
        lineHeightUnits: atom.config.get('css-unit-converter.lineHeightUnits'),
        defaultBase: atom.config.get('css-unit-converter.defaultBase')
      };
...
export default new CSSUnitConverter();
